...
<Image
    ...
    src={`/static/images/deep_dive_into_lamport_clock_and_lamport_vector_clock/causality.png`}
    width={1187}
    height={620}
    priority="true"
/>
...
<Image
    alt={`Lamport Clocks`}
    src={`/static/images/deep_dive_into_lamport_clock_and_lamport_vector_clock/lamportclock.png`}
    width={1323}
    height={622}
/>
...
<Image
    ...
    src={`/static/images/deep_dive_into_lamport_clock_and_lamport_vector_clock/vectorclocks.png`}
    width={1322}
    height={702}
/>
